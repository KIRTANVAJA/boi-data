export const defaultData = {
  ...
  // 5. Skills
  skills: [
    { name: "React.js & Next.js", levelPercent: 95, category: "Frontend" },
    { name: "JavaScript / TypeScript", levelPercent: 90, category: "Frontend" },
    { name: "Bootstrap 5 & TailwindCSS", levelPercent: 95, category: "Frontend" },
    { name: "Node.js & Express.js", levelPercent: 88, category: "Backend" },
    { name: "REST APIs & WebSockets", levelPercent: 90, category: "Backend" },
    { name: "AWS (S3, EC2, Lambda)", levelPercent: 80, category: "Cloud" },
    { name: "Problem Solving & Logic", levelPercent: 95, category: "Soft" }
  ],
